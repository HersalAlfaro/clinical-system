...
public interface MedicamentosDao extends JpaRepository<Medicamentos, Long> {
    ...
    @Query(value = "CALL paquete_medicamentos.ingresoMedicamento(:nombre,:descripcion, :indicaciones, :efectos, :fecha, :costo, :dosis)", nativeQuery = true)
    public void ingresoMedicamento(
       ...
       @Query(value = "CALL paquete_medicamentos.obtenerMedicamento(:codigo)", nativeQuery = true)
    ...
    @Query(value = "CALL paquete_medicamentos.actualizarMedicamento(:p_codigo_medicamento ,:p_nombre,:p_descripcion, :p_indicaciones, :p_efectos, :p_fecha, :p_costo, :p_dosis)", nativeQuery = true)
    public void actualizarMedicamento(
     ...
     @Query(value = "CALL paquete_medicamentos.eliminarMedicamento(:p_codigo_medicamento)", nativeQuery = true)
